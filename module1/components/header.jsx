  ...
  return (
    <div>
      <header className="text-gray-400 bg-gray-900 body-font">
        ...
        pathname === "/about" ? "text-white font-semibold" : "text-gray-400"
      }`}>About</Link>
            <Link href={"/user"} className={`mr-5 hover:text-white ${
        pathname === "/user" ? "text-white font-semibold" : "text-gray-400"
      }`}>User</Link>
            <Link href={"/contact"} className={`mr-5 hover:text-white ${
        pathname === "/contact" ? "text-white font-semibold" : "text-gray-400"
      }`}>Contact</Link>
          </nav>
