    ...
    <div>
      <section className="text-gray-400 bg-gray-900 body-font">
        <div className="container mx-auto flex px-5 py-24 items-center justify-center flex-col">
          <img className="lg:w-2/6 md:w-3/6 w-5/6 mb-10 object-cover object-center rounded" alt="hero" src="https://media.istockphoto.com/id/112785729/photo/emerald-swallowtail.webp?a=1&b=1&s=612x612&w=0&k=20&c=G6-OApKxOTKb1rQOJbLg8T9STqzBIqkfIr-i2AeL0wU="/>
